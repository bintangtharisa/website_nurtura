...
{{-- ── PAGE HEADER: Diambil dari gaya monitoring agar jaraknya rapat ── --}}
...
{{-- Grid Utama: Mengikuti struktur Monitoring (Kiri lebar, Kanan Sidebar) --}}
<div style="display: grid; grid-template-columns: 1fr 320px; gap: 18px; align-items: start; margin-top: 20px;">
    ...
    <div style="display: flex; flex-direction: column; gap: 18px;">
            ...
            <div class="card__body">
                <div style="display: flex; gap: 24px; align-items: flex-start;">
                    ...
                    <div style="position: relative; flex-shrink: 0;">
                        <div style="width: 80px; height: 80px; border-radius: 50%; background: var(--clr-bg); border: 2px solid var(--clr-border-light); display: flex; align-items: center; justify-content: center; overflow: hidden;">
        ...
        <div style="display: flex; justify-content: flex-end; gap: 12px; margin-top: 10px;">
            <button type="button" class="btn btn--outline" style="padding: 10px 24px;">Batalkan</button>
            <button type="button" class="btn btn--primary" style="padding: 10px 24px;">Simpan Perubahan</button>
        </div>
    </div>
    ...
    <div style="display: flex; flex-direction: column; gap: 18px;">
        <div class="card">
            ...
            <div class="card__body">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;">
                    ...
                    <div>
                        ...
                        <div style="font-size: 11px; color: var(--clr-text-muted);">
                             Sejak {{ isset($wife) ? \Carbon\Carbon::parse($wife->connected_at)->translatedFormat('d M Y') : '12 Jan 2024' }}
                        </div>
                    </div>
                </div>

                <div style="display: flex; flex-direction: column; gap: 8px; margin-bottom: 16px;">
                    <div style="display: flex; align-items: center; gap: 8px; font-size: 11.5px; color: var(--clr-text-heading); background: var(--clr-bg); padding: 8px 12px; border-radius: 6px;">
                ...
                <div style="padding: 10px; background: #FFF4E5; border-radius: 8px; border-left: 3px solid #FF9800; display: flex; gap: 8px;">
                    <p style="font-size: 10.5px; color: #856404; margin: 0; line-height: 1.4;">
                         <b>Peringatan:</b> Jika koneksi diputus, update harian kondisi istri akan berhenti otomatis.
                    </p>
                </div>
            </div>
        </div>
