...
<head>
    ...
    <style>
        ...
        /* Fix scrollbar for notification list */
        .topbar__notif-list::-webkit-scrollbar { width: 4px; }
        .topbar__notif-list::-webkit-scrollbar-thumb { background: #E2E8F0; border-radius: 10px; }
    </style>
    @stack('styles')
</head>
<body>
            ...
            <ul class="sidebar__nav-list">
                ...
                <li class="sidebar__nav-item {{ request()->routeIs('admin.dashboard*') ? 'active' : '' }}">
                    <a href="{{ route('admin.dashboard') }}" class="sidebar__nav-link">
                        ...
                        <span class="sidebar__nav-label">Dashboard <small>Monitoring</small></span>
                    </a>
                </li>

                {{-- Artikel Section --}}
                <li class="sidebar__nav-item {{ request()->routeIs('admin.articles*') ? 'active' : '' }}">
                    <a href="{{ route('admin.articles') }}" class="sidebar__nav-link">
                        <span class="sidebar__nav-icon">
                        ...
                        <span class="sidebar__nav-label">Article Builder <small>Post Content</small></span>
                    </a>
                </li>
                ...
                <li class="sidebar__nav-item {{ request()->routeIs('admin.article-categories*') ? 'active' : '' }}">
                    <a href="{{ route('admin.article-categories') }}" class="sidebar__nav-link">
                        ...
                        <span class="sidebar__nav-label">Categories <small>Article Groups</small></span>
                    </a>
                </li>
                ...
                <li class="sidebar__nav-item {{ request()->routeIs('admin.skrining*') ? 'active' : '' }}">
                    <a href="{{ route('admin.skrining') }}" class="sidebar__nav-link">
                        ...
                        <span class="sidebar__nav-label">Data Skrining <small>(Anonim)</small></span>
                    </a>
                </li>
